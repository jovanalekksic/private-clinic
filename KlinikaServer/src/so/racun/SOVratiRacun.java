 ...
 * @author Jovana
 */
public class SOVratiRacun extends ApstraktnaSO{
    ...
    protected void execute(ApstraktniObjekat ao) throws SQLException {
        ArrayList<ApstraktniObjekat> racunIzBaze=DBBroker.getInstance().select(ao);
        lista=(ArrayList<Racun>)(ArrayList<?>)racunIzBaze;
    }
